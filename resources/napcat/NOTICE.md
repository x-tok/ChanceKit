...
This directory contains the unmodified official NapCatQQ 4.18.28 Shell release.
Source: https://github.com/NapNeko/NapCatQQ/tree/v4.18.28
...
Maintainers obtain the pinned archive with `npm run prepare:napcat` before building.
The desktop application extracts this local archive and never downloads NapCat.
