...
test('schedule surface stays focused on activities without a recruiting information panel', async () => {
  ...
  try {
    ...
    await expect(page.getByRole('region', { name: '当日活动', exact: true })).toBeVisible();
